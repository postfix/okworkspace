...
- [ ] **LINK-01**: System maintains a derived page-link / backlink index, built from existing Markdown link parsing, kept fresh on every page mutation (create / save / rename / move / delete-to-trash / restore)
