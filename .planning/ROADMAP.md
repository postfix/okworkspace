...
- [ ] 09-01-PLAN.md — read-only `internal/graph` query layer (GraphData/Neighborhood/Backlinks, popular-tag cap) + authed `/api/v1/graph`, `/graph/local`, `/graph/backlinks` endpoints (LINK-02)
...
| 9. Graph Endpoints & Backlinks Panel | v1.0 | 0/2 | Planned | - |
